...
class AppTagLib {
    ...
    /**
     * This tag enables sort in an ascending/descending pedido on the particular attribute of an object, asynchronously.
    ...
    def remoteSortableColumn = { attrs ->
        ...
        // current sorting property and pedido
        ...
        // determine and add sorting pedido for this column to link params
